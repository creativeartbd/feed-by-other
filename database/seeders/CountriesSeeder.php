...
class CountriesSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('countries')->insert([
            ...
            ['country_name' => 'British Indian Ocean Territory (the)', 'code' => 'IO'],
            ...
            ['country_name' => 'Cayman Islands (the)', 'code' => 'KY'],
            ['country_name' => 'Central African Republic (the)', 'code' => 'CF'],
            ['country_name' => 'Chad', 'code' => 'TD'],
            ['country_name' => 'Chile', 'code' => 'CL'],
            ['country_name' => 'China', 'code' => 'CN'],
            ['country_name' => 'Christmas Island', 'code' => 'CX'],
            ['country_name' => 'Cocos (Keeling) Islands (the)', 'code' => 'CC'],
            ['country_name' => 'Colombia', 'code' => 'CO'],
            ['country_name' => 'Comoros (the)', 'code' => 'KM'],
            ['country_name' => 'Congo (the Democratic Republic of the)', 'code' => 'CD'],
            ['country_name' => 'Congo (the)', 'code' => 'CG'],
            ['country_name' => 'Cook Islands (the)', 'code' => 'CK'],
            ...
            ['country_name' => 'Dominican Republic (the)', 'code' => 'DO'],
            ...
            ['country_name' => 'Falkland Islands (the) [Malvinas]', 'code' => 'FK'],
            ['country_name' => 'Faroe Islands (the)', 'code' => 'FO'],
            ...
            ['country_name' => 'Korea (the Democratic People\'s Republic of)', 'code' => 'KP'],
            ['country_name' => 'Korea (the Republic of)', 'code' => 'KR'],
            ['country_name' => 'Kuwait', 'code' => 'KW'],
            ['country_name' => 'Kyrgyzstan', 'code' => 'KG'],
            ['country_name' => 'Lao People\'s Democratic Republic (the)', 'code' => 'LA'],
            ...
            ['country_name' => 'Marshall Islands (the)', 'code' => 'MH'],
            ...
            ['country_name' => 'Moldova (the Republic of)', 'code' => 'MD'],
            ...
            ['country_name' => 'Philippines (the)', 'code' => 'PH'],
            ...
            ['country_name' => 'Republic of North Macedonia', 'code' => 'MK'],
            ['country_name' => 'Romania', 'code' => 'RO'],
            ['country_name' => 'Russian Federation (the)', 'code' => 'RU'],
            ...
            ['country_name' => 'Sudan (the)', 'code' => 'SD'],
            ...
            ['country_name' => 'United Arab Emirates (the)', 'code' => 'AE'],
            ['country_name' => 'United Kingdom of Great Britain and Northern Ireland', 'code' => 'GB'],
            ['country_name' => 'United States Minor Outlying Islands', 'code' => 'UM'],
            ['country_name' => 'United States of America', 'code' => 'US'],
