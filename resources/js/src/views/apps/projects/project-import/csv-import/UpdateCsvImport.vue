                        ...
                        <b-col md="6">
                            <b-row>
                                <b-col md="12" class="mb-2">
                                    ...
                                    >
                                        <b-form-input
                                            ...
                                            :state="errors.length > 0 ? false : null"
                                            id="csv-file-url"
                                            placeholder="Enter your csv file URL"
                                        />
                                        <small class="text-danger">{{ errors[0] }}</small>
                                    </validation-provider>
                                </b-col>
                                <b-col md="12" class="mb-2">
                                    ...
                                    <validation-provider #default="{ errors }" name="Column separator" rules="required">
                                        <b-form-select
                                            v-model="mappingData.column_separator"
                                            :options="list_of_separator"
                                            :state="errors.length > 0 ? false : null"
                                        />
                                        <small class="text-danger">{{ errors[0] }}</small>
                                    </validation-provider>
                                ...
                                <b-col md="12" class="mb-1">
                                    <label> CSV has header</label> <br/>
                                    <b-form-checkbox
                                        v-model="mappingData.csv_has_header"
                                        checked="true"
                                ...
                                <div v-else>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div v-if="isMatched" class="mt-3">
                                            <div class="alert alert-danger">You must map the "{{ mappingData.match_products_by }}" field.</div>
                                        </div>
                                    </div>
                                    <b-button
                                        variant="outline-dark"
            ...
            .then((response) => {
                ...
                if (Object.keys(response.data).length !== 0) {
                    ...
                    mapping_data.forEach((item) => {
                        ...
                        this.mappingData.column_separator = JSON.parse(item.params).column_separator;
                        this.mappingData.csv_has_header = JSON.parse(item.params).csv_has_header == 1 ? true : null;
                        this.mappingData.advanced_option = JSON.parse(item.params).advanced_option == 1 ? true : null;
                        ...
                        console.log( JSON.parse(item.params).csv_has_header )
                    });
                        ...
                        if(item.internal_field_slug !== 'ts_product_item_wrapper') {
                            if( item.custom_field == 2 ) {
                                this.newRow.push({
                                    ...
                                    custom_field: item.custom_field == 2 ? item.internal_field_slug : "",
                                ...
                                this.mappingData.projectFieldOptions.push({
                                    value: item.import_field_slug,
                                    text: item.custom_field == 1 ? "Do Not Import" : item.internal_field_slug,
                                    custom: item.custom_field == 1 ? true : null,
                                    custom_field: item.custom_field == 1 ? item.internal_field_slug : "",
                                    id_feed_mappings: item.id_feed_mappings,
                                    updates: item.updates == 1 ? true : null,
                                    removes: item.removes == 1 ? true : null,
                                });
    ...
    methods: {
        ...
        callHttp(isRefreshed) {
            let importData = {
                ...
                column_separator: this.mappingData.column_separator,
                feed_type : 'csv',
                csv_has_header : this.mappingData.csv_has_header,
            };
        ...
        validateSafety() {
            this.$refs.validateSafety.validate().then((success) => {
                ...
                // show notification message
                    ...
                    if( this.newRow.length > 0 ) {
                        this.mappingData.mergedFieldOptions = [...this.mappingData.projectFieldOptions, ...this.newRow ];
                    } else {
