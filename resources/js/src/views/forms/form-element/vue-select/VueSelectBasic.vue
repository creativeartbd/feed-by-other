...
export default {
  ...
  data() {
    return {
      ...
      option: [{ title: 'Square' }, { title: 'Website Design and Developmetn project of mine of bangladesh', }, { title: 'Rombo' }, { title: 'Romboid' }],
      books: [
        {
          title: 'Website Design and Developmetn project of mine of bangladesh',
          icon: 'ApertureIcon',
        },
        {
          title: 'Codepen',
